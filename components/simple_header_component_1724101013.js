...
Vue.component("simple_header_component_1724101013", {
    template: `
    <header id="header-section" style="min-height: 470px"     class="w-full">
        <nav id="nav-bar" class="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
            <div id="nav-container" class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                <a id="logo-link" href="#" class="flex items-center">
                    ...
                    <span id="app-name" class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">SwapWave</span>
                </a>
...
<section class="bg-purple-100 py-20">
        <div class="max-w-screen-xl mx-auto px-4">
            ...
            <form class="max-w-2xl mx-auto bg-white bg-opacity-20 backdrop-filter backdrop-blur-lg p-8 rounded-lg shadow-lg">
                <div class="mb-6">
                    <label for="email" class="block mb-2 text-sm font-medium text-purple-700">Email Address</label>
                    <input type="email" id="email" class="w-full px-4 py-3 border border-purple-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500 bg-white bg-opacity-50" placeholder="Enter your email" required>
                </div>
                <div class="mb-6">
                    <label for="address" class="block mb-2 text-sm font-medium text-purple-700">Physical Address</label>
                    <input type="text" id="address" class="w-full px-4 py-3 border border-purple-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500 bg-white bg-opacity-50" placeholder="Enter your address" required>
                </div>
